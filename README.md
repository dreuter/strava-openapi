# Rust API client for strava-openapi
...
Put the package under your project folder in a directory named `strava-openapi` and add the following to `Cargo.toml` under `[dependencies]`:

```
strava-openapi = { path = "./strava-openapi" }
```
