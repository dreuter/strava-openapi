...
pub async fn get_stats(configuration: &configuration::Configuration, id: i64) -> Result<models::ActivityStats, Error<GetStatsError>> {
    let local_var_configuration = configuration;
...
pub async fn update_logged_in_athlete(configuration: &configuration::Configuration, ) -> Result<models::DetailedAthlete, Error<UpdateLoggedInAthleteError>> {
    let local_var_configuration = configuration;
