...
**photos** | Option<[**models::PhotosSummary**](PhotosSummary.md)> |  | [optional]
**gear** | Option<[**models::SummaryGear**](SummaryGear.md)> |  | [optional]
**calories** | Option<**f32**> | The number of kilocalories consumed during this activity | [optional]
**segment_efforts** | Option<[**Vec<models::DetailedSegmentEffort>**](DetailedSegmentEffort.md)> |  | [optional]
...
**splits_metric** | Option<[**Vec<models::Split>**](Split.md)> | The splits of this activity in metric units (for runs) | [optional]
**splits_standard** | Option<[**Vec<models::Split>**](Split.md)> | The splits of this activity in imperial units (for runs) | [optional]
**laps** | Option<[**Vec<models::Lap>**](Lap.md)> |  | [optional]
**best_efforts** | Option<[**Vec<models::DetailedSegmentEffort>**](DetailedSegmentEffort.md)> |  | [optional]
