...
> Vec<models::ClubActivity> get_club_activities_by_id(id, page, per_page)
...
> Vec<models::SummaryAthlete> get_club_admins_by_id(id, page, per_page)
...
> models::DetailedClub get_club_by_id(id)
Get Club
...
> Vec<models::ClubAthlete> get_club_members_by_id(id, page, per_page)
List Club Members
...
> Vec<models::SummaryClub> get_logged_in_athlete_clubs(page, per_page)
List Athlete Clubs
